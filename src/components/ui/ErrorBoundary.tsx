    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="w-full min-h-[40vh] flex flex-col items-center justify-center p-6 text-center">
          ...
          <p className="text-slate-300 mb-4">Intenta recargar la página. Si el problema persiste, vuelve más tarde.</p>
          <button onClick={this.handleRetry} className="px-4 py-2 rounded-xl text-sm font-medium bg-blue-600 text-white hover:bg-blue-700">
            Reintentar
          </button>
        </div>
      )
